    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
            ...
            <Card variant="default">
              <Text className="text-gray-700 text-sm">
                ...
                The same component works identically on mobile.
              </Text>
            </Card>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white p-3 rounded border border-purple-100">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-medium text-purple-900 text-sm">Mobile</span>
                </div>
        ...
        <section className="mt-12 text-center">
          <Link href="/" className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 transition-colors text-white rounded-lg px-6 py-2 font-medium text-sm gap-2">
            <span>🏠</span>
